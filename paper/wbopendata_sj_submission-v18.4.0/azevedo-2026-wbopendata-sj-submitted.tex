...
an aspirational norm to a default behavior. Versions~18.0 through~18.4 extend this approach
...
\caption{Mobile cellular subscriptions per 100 people, latest available year.}
\label{fig:map}
\end{figure}
...
\caption{Poverty headcount ratio versus GDP per capita across countries.}
\label{fig:scatter}
\end{figure}
...
\caption{GDP per capita in Africa, 2009.}
...
\caption{Fertility rate, births per woman, worldwide.}
