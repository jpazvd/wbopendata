...
local logname "`qa_dir'/logs/test_help_examples_`timestamp'.log"
...
local src_prefix "`src_path'/"
if (`use_dev' & strpos("`wb_path'", "`src_prefix'") == 0) {
    di as error "wbopendata not loaded from expected dev source: `wb_path'"
    di as error "Expected prefix: `src_prefix'"
