...
or API endpoint deprecations. The test suite comprises 71 integrated tests
distributed across 16 categories, covering environment validation, data download
...
and characteristic metadata verification.
Table~\ref{tab:test-coverage} summarizes the composition.

\begin{table}[H]
\centering
\caption{Test suite composition (71 tests across 16 categories)}
...
CTRY  & Country options   & 10 & Basic, full, geo, ISO, regions, income \\
...
invocation, discovery commands require approximately 9~seconds to parse the
...
publication-ready metadata handling, and a 71-test QA suite across 16 categories.
