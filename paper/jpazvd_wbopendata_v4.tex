...
\hline
\multicolumn{3}{l}{\textit{Discovery: \texttt{sources}}} \\
...
\hline
\multicolumn{3}{l}{\textit{Discovery: \texttt{alltopics}}} \\
...
\hline
\multicolumn{3}{l}{\textit{Discovery: \texttt{search(pattern)}}} \\
...
\hline
\multicolumn{3}{l}{\textit{Discovery: \texttt{info(code)}}} \\
...
or API endpoint deprecations. The test suite comprises 65 integrated tests
...
projections, cache management, metadata synchronization, and discovery commands.
Table~\ref{tab:test-coverage} summarizes the composition.

\begin{table}[H]
\centering
\caption{Test suite composition (65 tests across 15 categories)}
