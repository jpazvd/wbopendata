...
\hangpara
\texttt{searchfield(\ststring)} restricts search to specified metadata fields: \texttt{code}, \texttt{name}, \texttt{description}, \texttt{source}, \texttt{topic}, \texttt{note}, or \texttt{all} (default). Multiple fields can be separated by semicolons.
...
respectively.  The \texttt{metadataoffline} option, which previously generated
...
The author thanks Kit Baum for comments on an earlier draft and for pointing toward important references, and Aart Kraay for questions and nudges toward interesting features to be included.  Thanks also to the World Bank Open Data Initiative for making development data freely accessible, and to the many users who have contributed bug reports and feature suggestions through GitHub.
