...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{../doc/images/wbopendata_8.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{../doc/images/wbopendata_12.png}
...
Note: PDF format is preferred for figures in Stata Journal submissions; PNG files shown here are for preview purposes. All graphs should follow the \texttt{sj} scheme for consistency with journal standards.
