...
\subsection*{Note on figure formats}

PDF format is preferred for figures in Stata Journal submissions; PNG files shown here are for preview purposes. All graphs should follow the \texttt{sj} scheme for consistency with journal standards.
