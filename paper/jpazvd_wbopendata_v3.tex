...
to Stata’s graphing commands. \ref{fig:linewrap} illustrates this workflow by constructing
...
deprecated indicators and metadata updates are reported in Appendix~B.
...
\subsubsection{Metadata-driven graph annotation (supporting Figure~\ref{fig:linewrap})}
\begin{stlog}
...
deprecated series, and metadata update behavior—are reported in Appendix~B.
Appendix~B documents \emph{what users see}, while the present appendix documents
