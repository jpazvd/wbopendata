*******************************************************************************
*! __wbopendata_search_cache v3.4.0  25Apr2026
*! v3.4.0: Extract alias/name lookup tables to __wbod_search_aliases helper
*! v3.3.1: Strip leading zeros from src_id before alias lookup
...
program define __wbopendata_search_cache, rclass
    ...
    *---------------------------------------------------------------------------
    if ("`detail'" != "") {
        ...
        * Populate src_alias_*, src_name_*, topic_name_* in this scope
