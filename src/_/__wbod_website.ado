...
program define __wbod_website, rclass
...
__wbod_website, text("`ex1'")
__wbod_website, text("`ex1'") short(link)


local ex2 "World Bank, Enterprise Surveys (http://www.enterprisesurveys.org/)."
__wbod_website, text("`ex2'")
__wbod_website, text("`ex2'") short(link)


local ex3 "World Bank, Doing Business project (http://www.doingbusiness.org/)."
__wbod_website, text("`ex3'")
__wbod_website, text("`ex3'") short(link)


local ex4 "Robert J. Barro and Jong-Wha Lee: http://www.barrolee.com/"
__wbod_website, text("`ex4'")
__wbod_website, text("`ex4'") short(link)
...
__wbod_website, text("`ex5'")
__wbod_website, text("`ex5'") short(link)
...
__wbod_website, text("`ex6'")
__wbod_website, text("`ex6'") short(link)
...
__wbod_website, text("`ex7'")
__wbod_website, text("`ex7'") short(link)
...
__wbod_website, text("`ex8'")
__wbod_website, text("`ex8'") short(link)
