...
insheet using file2.txt , delimiter("#") clear name
			...
			********************************************
			...
			foreach topic in `r(levels)' {
				...
				forvalues line = `min'(1)`max'  {
					...
					file write `hlp`variable''  "{synopt:{help wbopendata_`variable'_indicators`topicode0'##`variable'_`indicatorcode':`indicatorcode'}}`indicatorname'{p_end}" _n
					file write `hlp`variable''  "{marker `indicatorcode'}"  _n
...
*/
	...
	qui foreach topic in `levelsof2'  {	
		...
		file open `hlp`variable'`tc0''		using 	`help`variable'`tc0'' , write text replace
			...
			file write `hlp`variable'`tc0'' "{title:`title' (as of `date')}" 		_n
			file write `hlp`variable'`tc0'' "" 							_n
			...
			********************************************
			...
			file write `hlp`variable'`tc0'' "" 				_n
				...
				file write `hlp`variable'`tc0''  "" _n
				file write `hlp`variable'`tc0'' "{synoptset 25 tabbed}{...}" 	_n
				file write `hlp`variable'`tc0'' "{synopthdr:`topicode1'}" _n
				file write `hlp`variable'`tc0'' "{synoptline}" 				_n
				...
				forvalues line = `min'(1)`max'  {
					...
					local indicatorname 		= indicatorname 		in `line'
					local indicatorcode 		= indicatorcode   		in `line'
					local sourceid 				= sourceid 				in `line'
					local sourceorganization	= sourceorganization 	in `line'
					local sourcenote			= sourcenote			in `line'
					local topicid 				= topicid				in `line'
					
					file write `hlp`variable'`tc0''  "" _n
					file write `hlp`variable'`tc0''  `"{dlgtab: {help wbopendata_`variable'##`indicatorcode':`indicatorcode'} - `indicatorname'}{marker `variable'_`indicatorcode'}"' _n
					file write `hlp`variable'`tc0''  "" _n
					file write `hlp`variable'`tc0''  "" _n
					file write `hlp`variable'`tc0''  `"{synopt:{opt Source}}`sourceid'.{p_end}"'  _n
					file write `hlp`variable'`tc0''  "" _n
					file write `hlp`variable'`tc0''  `"{synopt:{opt Topics}}`topicid'.{p_end}"'  _n
					file write `hlp`variable'`tc0''  "" _n
		...
		noi di in g in smcl "	See {bf:{it:{help wbopendata_`variable'_indicators`tc0'##`toc':`title' `tc0'}}}"
