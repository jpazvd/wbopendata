...
{marker sourceid_66}
{p 40 20 2}(Go up to {it:{help wbopendata##sourceid:Source}} or {it:{help wbopendata_sourceid_indicators66##:TOC}}){p_end}

{synoptset 25 tabbed}{...}
{syntab:{title:{bf:66 Logistics Performance Index}}}
{synoptline}
{marker sourceid_LO.PISA.REA.0.FE}
{synopt:{bf:{help wbopendata_sourceid##LO.PISA.REA.0.FE:LO.PISA.REA.0.FE} - Logistics performance index: Overall rank (1=highest performance)PISA: Female 15-year-olds by reading proficiency level (%). Below Level 1B}}
...
{synopt:{bf:{help wbopendata_sourceid##LP.IMP.DURS.MD:LP.IMP.DURS.MD} - Efficiency of the clearance process, rank (1=highest performer)Lead time to import, median case (days)}}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Efficiency of the clearance process includes results from the survey question Rate the efficiency of the clearance{p_end}

{synopt:{opt Source Organization}}World Bank Logistics Performance Index Surveys. Data and methodology are available at: http://www.worldbank.org/lpiWorld Bank and Turku School of Economics, Logistic Performance Index Surveys. Data are available online at : http://www.worldbank.org/lpi. Summary results are published in Arvis and others' Connecting to Compete: Trade Logistics in the Global{p_end}


{synoptline}
{marker sourceid_LP.LPI.CUST.XQ}
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.CUST.XQ:LP.LPI.CUST.XQ} - Logistics performance index: Efficiency of customs clearance process (1=low to 5=high)Quality- of trade and transport-related infrastructure, rank (1=highest performer)}}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Quality of trade- and transport-related infrastructure includes results from the survey question Evaluate the quali{p_end}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.INFR.XQ:LP.LPI.INFR.XQ} - Ease of arranging competitively priced international shipments, rank (1=highest performer)Logistics performance index: Quality of trade and transport-related infrastructure (1=low to 5=high)}}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Ease of arranging competitively priced international shipments includes results from the survey question Assess the{p_end}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.ITRN.XQ:LP.LPI.ITRN.XQ} - Competence and quality of logistics services, rank (1=highest performer)Logistics performance index: Ease of arranging competitively priced shipments (1=low to 5=high)}}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Competence and quality of logistics services includes results from the survey question Evaluate the overall level o{p_end}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.RK:LP.LPI.OVRL.RK} - Logistics performance index: Overall rank (1=highest performance)Logistics performance index: Overall rank (1=highest performance), lower bound}}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.RK.LB:LP.LPI.OVRL.RK.LB} - Logistics performance index: Overall rank (1=highest performance), lower boundLogistics performance index: Overall rank (1=highest performance), upper bound}}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.RK.UB:LP.LPI.OVRL.RK.UB} - Logistics performance index: Overall rank (1=highest performance), upper boundLogistics performance index: Percent of highest performer)}}

{synopt:{opt Source}}66 Logistics Performance Index{p_end}


{synopt:{opt Source Notes}}The Logistics Performance Index overall rank reflects perceptions of a countrys logistics performance based on the efficiency of the customs clearance process, quality of trade- and transport-related infrastructure, ease of arranging competitiThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on the efficiency of the customs clearance process, quality of trade- and transport-related infrastructure, ease of arranging competitively priced i{p_end}
...
{synopt:{opt Source Notes}}Logistics Performance Index overall score reflects perceptions of a country's logistics based on efficiency of customs clearance process, quality of trade- and transport-related infrastructure, ease of arranging competitively priced shipments,The Logistics Performance Index reflects perceptions of a countrys logistics performance based on the efficiency of the customs clearance process, quality of trade- and transport-related infrastructure, ease of arranging competitively priced i{p_end}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.XQ:LP.LPI.OVRL.XQ} - Logistics performance index: Overall (1=low to 5=high)Logistics performance index: Overall score (1=low to 5=high), lower bound}}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.XQ.LB:LP.LPI.OVRL.XQ.LB} - Logistics performance index: Overall score (1=low to 5=high), lower boundLogistics performance index: Overall score (1=low to 5=high), upper bound}}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.OVRL.XQ.UB:LP.LPI.OVRL.XQ.UB} - Frequency with which shipments reach consignee within scheduled or expected time, rank (1=highest performer)Logistics performance index: Overall score (1=low to 5=high), upper bound}}

{synopt:{opt Source}}66 Logistics Performance Index{p_end}


{synopt:{opt Source Notes}}The Logistics Performance Index overall score reflects perceptions of a countrys logistics performance based on the efficiency of the customs clearance process, quality of trade- and transport-related infrastructure, ease of arranging competitThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Frequency with which shipments reach consignee within scheduled or expected time includes results from the survey q{p_end}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Frequency with which shipments reach consignee within scheduled or expected time includes results from the survey q{p_end}
...
{synopt:{bf:{help wbopendata_sourceid##LP.LPI.TIME.XQ:LP.LPI.TIME.XQ} - Ability to track and trace consignments, rank (1=highest performer)Logistics performance index: Frequency with which shipments reach consignee within scheduled or expected time (1=low to 5=high)}}
...
{synopt:{opt Source Notes}}Data are from Logistics Performance Index surveys conducted by the World Bank in partnership with academic and international institutions and private companies and individuals engaged in international logistics. 2009 round of surveys covered mThe Logistics Performance Index reflects perceptions of a countrys logistics performance based on six components. The component Ability to track and trace consignments includes results from the survey question Rate the ability to track and tra{p_end}
