...
{marker topicid_06}
{p 40 20 2}(Go up to {it:{help wbopendata##topicid:Topics}} or {it:{help wbopendata_topicid_indicators06##:TOC}}){p_end}

{synoptset 25 tabbed}{...}
{synopthdr:06 Environment}
{synoptline}

{dlgtab: {help wbopendata_topicid##AG.LND.AGRI.ZS:AG.LND.AGRI.ZS} - Agricultural land (% of land area)}{marker topicid_AG.LND.AGRI.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.ARBL.ZS:AG.LND.ARBL.ZS} - Arable land (% of land area)}{marker topicid_AG.LND.ARBL.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.EL5M.RU.K2:AG.LND.EL5M.RU.K2} - Rural land area where elevation is below 5 meters (sq. km)}{marker topicid_AG.LND.EL5M.RU.K2}
...
{dlgtab: {help wbopendata_topicid##AG.LND.EL5M.RU.ZS:AG.LND.EL5M.RU.ZS} - Rural land area where elevation is below 5 meters (% of total land area)}{marker topicid_AG.LND.EL5M.RU.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.EL5M.UR.K2:AG.LND.EL5M.UR.K2} - Urban land area where elevation is below 5 meters (sq. km)}{marker topicid_AG.LND.EL5M.UR.K2}
...
{dlgtab: {help wbopendata_topicid##AG.LND.EL5M.UR.ZS:AG.LND.EL5M.UR.ZS} - Urban land area where elevation is below 5 meters (% of total land area)}{marker topicid_AG.LND.EL5M.UR.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.EL5M.ZS:AG.LND.EL5M.ZS} - Land area where elevation is below 5 meters (% of total land area)}{marker topicid_AG.LND.EL5M.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.FRST.K2:AG.LND.FRST.K2} - Forest area (sq. km)}{marker topicid_AG.LND.FRST.K2}
...
{dlgtab: {help wbopendata_topicid##AG.LND.FRST.ZS:AG.LND.FRST.ZS} - Forest area (% of land area)}{marker topicid_AG.LND.FRST.ZS}
...
{dlgtab: {help wbopendata_topicid##AG.LND.PRCP.MM:AG.LND.PRCP.MM} - Average precipitation in depth (mm per year)}{marker topicid_AG.LND.PRCP.MM}
...
{dlgtab: {help wbopendata_topicid##AG.LND.TOTL.K2:AG.LND.TOTL.K2} - Land area (sq. km)}{marker topicid_AG.LND.TOTL.K2}
...
{dlgtab: {help wbopendata_topicid##AG.LND.TOTL.RU.K2:AG.LND.TOTL.RU.K2} - Rural land area (sq. km)}{marker topicid_AG.LND.TOTL.RU.K2}
...
{dlgtab: {help wbopendata_topicid##AG.LND.TOTL.UR.K2:AG.LND.TOTL.UR.K2} - Urban land area (sq. km)}{marker topicid_AG.LND.TOTL.UR.K2}
...
{dlgtab: {help wbopendata_topicid##AG.SRF.TOTL.K2:AG.SRF.TOTL.K2} - Surface area (sq. km)}{marker topicid_AG.SRF.TOTL.K2}
...
{dlgtab: {help wbopendata_topicid##EE.BOD.TOTL.KG:EE.BOD.TOTL.KG} - Organic water pollutant (BOD) emissions (kg per day)}{marker topicid_EE.BOD.TOTL.KG}
...
{dlgtab: {help wbopendata_topicid##EG.CFT.ACCS.ZS:EG.CFT.ACCS.ZS} - Access to clean fuels and technologies for cooking (% of population)}{marker topicid_EG.CFT.ACCS.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.EGY.PRIM.PP.KD:EG.EGY.PRIM.PP.KD} - Energy intensity level of primary energy (MJ/$2011 PPP GDP)}{marker topicid_EG.EGY.PRIM.PP.KD}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.ACCS.ZS:EG.ELC.ACCS.ZS} - Access to electricity (% of population)}{marker topicid_EG.ELC.ACCS.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.FOSL.ZS:EG.ELC.FOSL.ZS} - Electricity production from oil, gas and coal sources (% of total)}{marker topicid_EG.ELC.FOSL.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.RNEW.ZS:EG.ELC.RNEW.ZS} - Renewable electricity output (% of total electricity output)}{marker topicid_EG.ELC.RNEW.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.RNWX.KH:EG.ELC.RNWX.KH} - Electricity production from renewable sources, excluding hydroelectric (kWh)}{marker topicid_EG.ELC.RNWX.KH}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.RNWX.ZS:EG.ELC.RNWX.ZS} - Electricity production from renewable sources, excluding hydroelectric (% of total)}{marker topicid_EG.ELC.RNWX.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.FEC.RNEW.ZS:EG.FEC.RNEW.ZS} - Renewable energy consumption (% of total final energy consumption)}{marker topicid_EG.FEC.RNEW.ZS}
...
{dlgtab: {help wbopendata_topicid##EG.NSF.ACCS.ZS:EG.NSF.ACCS.ZS} - Access to non-solid fuel (% of population)}{marker topicid_EG.NSF.ACCS.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.EG.ZS:EN.ATM.CO2E.EG.ZS} - CO2 intensity (kg per kg of oil equivalent energy use)}{marker topicid_EN.ATM.CO2E.EG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.GF.KT:EN.ATM.CO2E.GF.KT} - CO2 emissions from gaseous fuel consumption (kt)}{marker topicid_EN.ATM.CO2E.GF.KT}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.GF.ZS:EN.ATM.CO2E.GF.ZS} - CO2 emissions from gaseous fuel consumption (% of total)}{marker topicid_EN.ATM.CO2E.GF.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.KD.GD:EN.ATM.CO2E.KD.GD} - CO2 emissions (kg per 2010 US$ of GDP)}{marker topicid_EN.ATM.CO2E.KD.GD}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.KT:EN.ATM.CO2E.KT} - CO2 emissions (kt)}{marker topicid_EN.ATM.CO2E.KT}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.LF.KT:EN.ATM.CO2E.LF.KT} - CO2 emissions from liquid fuel consumption (kt)}{marker topicid_EN.ATM.CO2E.LF.KT}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.LF.ZS:EN.ATM.CO2E.LF.ZS} - CO2 emissions from liquid fuel consumption (% of total)}{marker topicid_EN.ATM.CO2E.LF.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.PC:EN.ATM.CO2E.PC} - CO2 emissions (metric tons per capita)}{marker topicid_EN.ATM.CO2E.PC}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.PP.GD:EN.ATM.CO2E.PP.GD} - CO2 emissions (kg per PPP $ of GDP)}{marker topicid_EN.ATM.CO2E.PP.GD}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.PP.GD.KD:EN.ATM.CO2E.PP.GD.KD} - CO2 emissions (kg per 2011 PPP $ of GDP)}{marker topicid_EN.ATM.CO2E.PP.GD.KD}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.SF.KT:EN.ATM.CO2E.SF.KT} - CO2 emissions from solid fuel consumption (kt)}{marker topicid_EN.ATM.CO2E.SF.KT}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.CO2E.SF.ZS:EN.ATM.CO2E.SF.ZS} - CO2 emissions from solid fuel consumption (% of total)}{marker topicid_EN.ATM.CO2E.SF.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.GHGO.KT.CE:EN.ATM.GHGO.KT.CE} - Other greenhouse gas emissions, HFC, PFC and SF6 (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.GHGO.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.GHGO.ZG:EN.ATM.GHGO.ZG} - Other greenhouse gas emissions (% change from 1990)}{marker topicid_EN.ATM.GHGO.ZG}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.GHGT.KT.CE:EN.ATM.GHGT.KT.CE} - Total greenhouse gas emissions (kt of CO2 equivalent)}{marker topicid_EN.ATM.GHGT.KT.CE}
...
{synopt:{opt Source Organization}}European Commission, Joint Research Centre (JRC)/Netherlands Environmental Assessment Agency (PBL). Emission Database for Global Atmospheric Research (EDGAR), EDGARv4.2 FT2012: http://edgar.jrc.ec.europa.eu/.{p_end}



{dlgtab: {help wbopendata_topicid##EN.ATM.GHGT.ZG:EN.ATM.GHGT.ZG} - Total greenhouse gas emissions (% change from 1990)}{marker topicid_EN.ATM.GHGT.ZG}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.HFCG.KT.CE:EN.ATM.HFCG.KT.CE} - HFC gas emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.HFCG.KT.CE}
...
{synopt:{opt Source Organization}}European Commission, Joint Research Centre (JRC)/Netherlands Environmental Assessment Agency (PBL). Emission Database for Global Atmospheric Research (EDGAR): http://edgar.jrc.ec.europa.eu/.{p_end}



{dlgtab: {help wbopendata_topicid##EN.ATM.METH.AG.KT.CE:EN.ATM.METH.AG.KT.CE} - Agricultural methane emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.METH.AG.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.AG.ZS:EN.ATM.METH.AG.ZS} - Agricultural methane emissions (% of total)}{marker topicid_EN.ATM.METH.AG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.EG.KT.CE:EN.ATM.METH.EG.KT.CE} - Methane emissions in energy sector (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.METH.EG.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.EG.ZS:EN.ATM.METH.EG.ZS} - Energy related methane emissions (% of total)}{marker topicid_EN.ATM.METH.EG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.IN.ZS:EN.ATM.METH.IN.ZS} - Energy related methane emissions (% of total)}{marker topicid_EN.ATM.METH.IN.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.KT.CE:EN.ATM.METH.KT.CE} - Methane emissions (kt of CO2 equivalent)}{marker topicid_EN.ATM.METH.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.METH.ZG:EN.ATM.METH.ZG} - Methane emissions (% change from 1990)}{marker topicid_EN.ATM.METH.ZG}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.AG.KT.CE:EN.ATM.NOXE.AG.KT.CE} - Agricultural nitrous oxide emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.NOXE.AG.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.AG.ZS:EN.ATM.NOXE.AG.ZS} - Agricultural nitrous oxide emissions (% of total)}{marker topicid_EN.ATM.NOXE.AG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.EG.KT.CE:EN.ATM.NOXE.EG.KT.CE} - Nitrous oxide emissions in energy sector (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.NOXE.EG.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.EG.ZS:EN.ATM.NOXE.EG.ZS} - Nitrous oxide emissions in energy sector (% of total)}{marker topicid_EN.ATM.NOXE.EG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.IN.ZS:EN.ATM.NOXE.IN.ZS} - Nitrous oxide emissions in industrial and energy processes (% of total nitrous oxide emissions)}{marker topicid_EN.ATM.NOXE.IN.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.KT.CE:EN.ATM.NOXE.KT.CE} - Nitrous oxide emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.NOXE.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.NOXE.ZG:EN.ATM.NOXE.ZG} - Nitrous oxide emissions (% change from 1990)}{marker topicid_EN.ATM.NOXE.ZG}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.PFCG.KT.CE:EN.ATM.PFCG.KT.CE} - PFC gas emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.PFCG.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.PM25.MC.M3:EN.ATM.PM25.MC.M3} - PM2.5 air pollution, mean annual exposure (micrograms per cubic meter)}{marker topicid_EN.ATM.PM25.MC.M3}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.PM25.MC.ZS:EN.ATM.PM25.MC.ZS} - PM2.5 air pollution, population exposed to levels exceeding WHO guideline value (% of total)}{marker topicid_EN.ATM.PM25.MC.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.ATM.SF6G.KT.CE:EN.ATM.SF6G.KT.CE} - SF6 gas emissions (thousand metric tons of CO2 equivalent)}{marker topicid_EN.ATM.SF6G.KT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.BIR.THRD.NO:EN.BIR.THRD.NO} - Bird species, threatened}{marker topicid_EN.BIR.THRD.NO}
...
{dlgtab: {help wbopendata_topicid##EN.CLC.DRSK.XQ:EN.CLC.DRSK.XQ} - Disaster risk reduction progress score (1-5 scale; 5=best)}{marker topicid_EN.CLC.DRSK.XQ}
...
{synopt:{opt Source Organization}}(UNISDR, 2009-2011 Progress Reports, http://www.preventionweb.net/english/hyogo)..{p_end}



{dlgtab: {help wbopendata_topicid##EN.CLC.GHGR.MT.CE:EN.CLC.GHGR.MT.CE} - GHG net emissions/removals by LUCF (Mt of CO2 equivalent)}{marker topicid_EN.CLC.GHGR.MT.CE}
...
{dlgtab: {help wbopendata_topicid##EN.CLC.MDAT.ZS:EN.CLC.MDAT.ZS} - Droughts, floods, extreme temperatures (% of population, average 1990-2009)}{marker topicid_EN.CLC.MDAT.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.CO2.BLDG.ZS:EN.CO2.BLDG.ZS} - CO2 emissions from residential buildings and commercial and public services (% of total fuel combustion)}{marker topicid_EN.CO2.BLDG.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.CO2.ETOT.ZS:EN.CO2.ETOT.ZS} - CO2 emissions from electricity and heat production, total (% of total fuel combustion)}{marker topicid_EN.CO2.ETOT.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.CO2.MANF.ZS:EN.CO2.MANF.ZS} - CO2 emissions from manufacturing industries and construction (% of total fuel combustion)}{marker topicid_EN.CO2.MANF.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.CO2.OTHX.ZS:EN.CO2.OTHX.ZS} - CO2 emissions from other sectors, excluding residential buildings and commercial and public services (% of total fuel combustion)}{marker topicid_EN.CO2.OTHX.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.CO2.TRAN.ZS:EN.CO2.TRAN.ZS} - CO2 emissions from transport (% of total fuel combustion)}{marker topicid_EN.CO2.TRAN.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.FSH.THRD.NO:EN.FSH.THRD.NO} - Fish species, threatened}{marker topicid_EN.FSH.THRD.NO}
...
{dlgtab: {help wbopendata_topicid##EN.HPT.THRD.NO:EN.HPT.THRD.NO} - Plant species (higher), threatened}{marker topicid_EN.HPT.THRD.NO}
...
{dlgtab: {help wbopendata_topicid##EN.MAM.THRD.NO:EN.MAM.THRD.NO} - Mammal species, threatened}{marker topicid_EN.MAM.THRD.NO}
...
{dlgtab: {help wbopendata_topicid##EN.POP.EL5M.RU.ZS:EN.POP.EL5M.RU.ZS} - Rural population living in areas where elevation is below 5 meters (% of total population)}{marker topicid_EN.POP.EL5M.RU.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.POP.EL5M.UR.ZS:EN.POP.EL5M.UR.ZS} - Urban population living in areas where elevation is below 5 meters (% of total population)}{marker topicid_EN.POP.EL5M.UR.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.POP.EL5M.ZS:EN.POP.EL5M.ZS} - Population living in areas where elevation is below 5 meters (% of total population)}{marker topicid_EN.POP.EL5M.ZS}
...
{dlgtab: {help wbopendata_topicid##EN.POP.SLUM.UR.ZS:EN.POP.SLUM.UR.ZS} - Population living in slums (% of urban population)}{marker topicid_EN.POP.SLUM.UR.ZS}
...
{synopt:{opt Source Organization}}UN HABITAT, retrieved from the United Nation's Millennium Development Goals database. Data are available at : http://mdgs.un.org/.{p_end}



{dlgtab: {help wbopendata_topicid##ER.FSH.AQUA.MT:ER.FSH.AQUA.MT} - Aquaculture production (metric tons)}{marker topicid_ER.FSH.AQUA.MT}
...
{dlgtab: {help wbopendata_topicid##ER.FSH.CAPT.MT:ER.FSH.CAPT.MT} - Capture fisheries production (metric tons)}{marker topicid_ER.FSH.CAPT.MT}
...
{dlgtab: {help wbopendata_topicid##ER.FSH.PROD.MT:ER.FSH.PROD.MT} - Total fisheries production (metric tons)}{marker topicid_ER.FSH.PROD.MT}
...
{dlgtab: {help wbopendata_topicid##ER.GDP.FWTL.M3.KD:ER.GDP.FWTL.M3.KD} - Water productivity, total (constant 2010 US$ GDP per cubic meter of total freshwater withdrawal)}{marker topicid_ER.GDP.FWTL.M3.KD}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.FWAG.ZS:ER.H2O.FWAG.ZS} - Annual freshwater withdrawals, agriculture (% of total freshwater withdrawal)}{marker topicid_ER.H2O.FWAG.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.FWDM.ZS:ER.H2O.FWDM.ZS} - Annual freshwater withdrawals, domestic (% of total freshwater withdrawal)}{marker topicid_ER.H2O.FWDM.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.FWIN.ZS:ER.H2O.FWIN.ZS} - Annual freshwater withdrawals, industry (% of total freshwater withdrawal)}{marker topicid_ER.H2O.FWIN.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.FWTL.K3:ER.H2O.FWTL.K3} - Annual freshwater withdrawals, total (billion cubic meters)}{marker topicid_ER.H2O.FWTL.K3}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.FWTL.ZS:ER.H2O.FWTL.ZS} - Annual freshwater withdrawals, total (% of internal resources)}{marker topicid_ER.H2O.FWTL.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.INTR.K3:ER.H2O.INTR.K3} - Renewable internal freshwater resources, total (billion cubic meters)}{marker topicid_ER.H2O.INTR.K3}
...
{dlgtab: {help wbopendata_topicid##ER.H2O.INTR.PC:ER.H2O.INTR.PC} - Renewable internal freshwater resources per capita (cubic meters)}{marker topicid_ER.H2O.INTR.PC}
...
{dlgtab: {help wbopendata_topicid##ER.LND.PTLD.ZS:ER.LND.PTLD.ZS} - Terrestrial protected areas (% of total land area)}{marker topicid_ER.LND.PTLD.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.MRN.PTMR.ZS:ER.MRN.PTMR.ZS} - Marine protected areas (% of territorial waters)}{marker topicid_ER.MRN.PTMR.ZS}
...
{dlgtab: {help wbopendata_topicid##ER.PTD.TOTL.ZS:ER.PTD.TOTL.ZS} - Terrestrial and marine protected areas (% of total territorial area)}{marker topicid_ER.PTD.TOTL.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.COAL.RT.ZS:NY.GDP.COAL.RT.ZS} - Coal rents (% of GDP)}{marker topicid_NY.GDP.COAL.RT.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.FRST.RT.ZS:NY.GDP.FRST.RT.ZS} - Forest rents (% of GDP)}{marker topicid_NY.GDP.FRST.RT.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.MINR.RT.ZS:NY.GDP.MINR.RT.ZS} - Mineral rents (% of GDP)}{marker topicid_NY.GDP.MINR.RT.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.NGAS.RT.ZS:NY.GDP.NGAS.RT.ZS} - Natural gas rents (% of GDP)}{marker topicid_NY.GDP.NGAS.RT.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.PETR.RT.ZS:NY.GDP.PETR.RT.ZS} - Oil rents (% of GDP)}{marker topicid_NY.GDP.PETR.RT.ZS}
...
{dlgtab: {help wbopendata_topicid##NY.GDP.TOTL.RT.ZS:NY.GDP.TOTL.RT.ZS} - Total natural resources rents (% of GDP)}{marker topicid_NY.GDP.TOTL.RT.ZS}
