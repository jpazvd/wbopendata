...
{dlgtab: {help wbopendata_sourceid##SN.SH.STA.WAST.ZS:SN.SH.STA.WAST.ZS} - Sub-National Prevalence of wasting (% of children under 5)}{marker sourceid_SN.SH.STA.WAST.ZS}
