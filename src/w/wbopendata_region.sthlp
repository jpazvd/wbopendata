...
<<<<<<< HEAD
{title:Region  (as of 29oct2019)}
=======
{title:Region  (as of 12apr2020)}
>>>>>>> check

{marker EAS}
{p 20 20 2}(Go up to {it:{help wbopendata##region:Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:East Asia and Pacific (EAS)}
{synoptline}
...
{p 20 20 2}(Go up to {it:{help wbopendata##region:Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:Europe and Central Asia (ECS)}
{synoptline}
...
{synopt:{opt GIB}}  Gibraltar {p_end}
...
{p 20 20 2}(Go up to {it:{help wbopendata##region:Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:Latin America and Caribbean (LCN)}
{synoptline}
...
{synopt:{opt VIR}}  Virgin Islands (US) {p_end}
...
{synopt:{opt MCA}}  Central America {p_end}
{synopt:{opt CEB}}  Central Europe and the Baltics {p_end}
{synopt:{opt EAR}}  Early-demographic dividend {p_end}
{synopt:{opt EAS}}  East Asia and Pacific {p_end}
{synopt:{opt BEA}}  East Asia and Pacific (IBRD-only countries) {p_end}
{synopt:{opt TEA}}  East Asia and Pacific (IDA and IBRD countries) {p_end}
{synopt:{opt DEA}}  East Asia and Pacific (IDA-eligible countries) {p_end}
{synopt:{opt EAP}}  East Asia and Pacific (excluding high income) {p_end}
...
{synopt:{opt BEC}}  Europe and Central Asia (IBRD-only countries) {p_end}
{synopt:{opt TEC}}  Europe and Central Asia (IDA and IBRD countries) {p_end}
{synopt:{opt DEC}}  Europe and Central Asia (IDA-eligible countries) {p_end}
{synopt:{opt CEU}}  Europe and Central Asia (IFC classification) {p_end}
{synopt:{opt ECA}}  Europe and Central Asia (excluding high income) {p_end}
{synopt:{opt EUU}}  European Union {p_end}
{synopt:{opt FCS}}  Fragile and conflict affected situations {p_end}
{synopt:{opt HPC}}  Heavily indebted poor countries (HIPC) {p_end}
{synopt:{opt HIC}}  High income {p_end}
{synopt:{opt BHI}}  IBRD countries classified as high income {p_end}
{synopt:{opt IBD}}  IBRD only {p_end}
...
{synopt:{opt DXS}}  IDA total, excluding Sub-Saharan Africa {p_end}
{synopt:{opt LTE}}  Late-demographic dividend {p_end}
{synopt:{opt LCN}}  Latin America and Caribbean {p_end}
{synopt:{opt LAC}}  Latin America and Caribbean (excluding high income) {p_end}
{synopt:{opt LCR}}  Latin America and the Caribbean {p_end}
{synopt:{opt BLA}}  Latin America and the Caribbean (IBRD-only countries) {p_end}
{synopt:{opt TLA}}  Latin America and the Caribbean (IDA and IBRD countries) {p_end}
{synopt:{opt DLA}}  Latin America and the Caribbean (IDA-eligible countries) {p_end}
...
{synopt:{opt LMY}}  Low and middle income {p_end}
...
{synopt:{opt NLS}}  Non-resource rich Sub-Saharan Africa countries, of which landlocked {p_end}
...
{synopt:{opt PST}}  Post-demographic dividend {p_end}
{synopt:{opt PRE}}  Pre-demographic dividend {p_end}
{synopt:{opt RRS}}  Resource rich Sub-Saharan Africa countries {p_end}
{synopt:{opt RSO}}  Resource rich Sub-Saharan Africa countries, of which oil exporters {p_end}
{synopt:{opt SST}}  Small states {p_end}
{synopt:{opt SAS}}  South Asia {p_end}
{synopt:{opt TSA}}  South Asia (IDA and IBRD) {p_end}
{synopt:{opt DSA}}  South Asia (IDA-eligible countries) {p_end}
{synopt:{opt CSA}}  South Asia (IFC classification) {p_end}
{synopt:{opt SCE}}  Southern Cone {p_end}
{synopt:{opt SSF}}  Sub-Saharan Africa {p_end}
{synopt:{opt BSS}}  Sub-Saharan Africa (IBRD-only countries) {p_end}
{synopt:{opt TSS}}  Sub-Saharan Africa (IDA and IBRD countries) {p_end}
{synopt:{opt DSS}}  Sub-Saharan Africa (IDA-eligible countries) {p_end}
{synopt:{opt CAA}}  Sub-Saharan Africa (IFC classification) {p_end}
{synopt:{opt SSA}}  Sub-Saharan Africa (excluding high income) {p_end}
...
{p 20 20 2}(Go up to {it:{help wbopendata##region:Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:Sub-Saharan Africa (SSF)}
{synoptline}
