...
{marker topicid_09}
{p 40 20 2}(Go up to {it:{help wbopendata##topicid:Topics}} or {it:{help wbopendata_topicid_indicators09##:TOC}}){p_end}
...
{dlgtab: {help wbopendata_topicid##EG.ELC.LOSS.ZS:EG.ELC.LOSS.ZS} - Electric power transmission and distribution losses (% of output)}{marker topicid_EG.ELC.LOSS.ZS}
...
{dlgtab: {help wbopendata_topicid##IE.ICT.PCAP.CD:IE.ICT.PCAP.CD} - Information and communication technology expenditure per capita (current US$)}{marker topicid_IE.ICT.PCAP.CD}
...
{dlgtab: {help wbopendata_topicid##IE.ICT.TOTL.CD:IE.ICT.TOTL.CD} - Information and communication technology expenditure (current US$)}{marker topicid_IE.ICT.TOTL.CD}
...
{dlgtab: {help wbopendata_topicid##IE.ICT.TOTL.GD.ZS:IE.ICT.TOTL.GD.ZS} - Information and communication technology expenditure (% of GDP)}{marker topicid_IE.ICT.TOTL.GD.ZS}
...
{dlgtab: {help wbopendata_topicid##IE.PPI.ICTI.CD:IE.PPI.ICTI.CD} - Investment in ICT with private participation (current US$)}{marker topicid_IE.PPI.ICTI.CD}
...
{synopt:{opt Source Notes}}Investment in ICT projects with private participation refers to commitments to projects in ICT backbone infrastructure (including land based and submarine cables) that have reached financial closure and directly or indirectly serve the public. Movable assets and small projects are excluded. The types of projects included are operations and management contracts, operations and management contracts with major capital expenditure, greenfield projects (in which a private entity or a public-private joint venture builds and operates a new facility), and divestitures. Investment commitments are the sum of investments in facilities and investments in government assets. Investments in facilities are the resources the project company commits to invest during the contract period either in new facilities or in expansion and modernization of existing facilities. Investments in government assets are the resources the project company spends on acquiring government assets such as state-owned enterprises, rights to provide services in a specific area, or the use of specific radio spectrums. Data are in current U.S. dollars and available 2015 onwards only..{p_end}
...
{dlgtab: {help wbopendata_topicid##IE.PPN.ENGY.CD:IE.PPN.ENGY.CD} - Public private partnerships investment in energy (current US$)}{marker topicid_IE.PPN.ENGY.CD}
...
{dlgtab: {help wbopendata_topicid##IE.PPN.TELE.CD:IE.PPN.TELE.CD} - Public private partnerships investment in telecom (current US$)}{marker topicid_IE.PPN.TELE.CD}
...
{dlgtab: {help wbopendata_topicid##IE.PPN.TRAN.CD:IE.PPN.TRAN.CD} - Public private partnerships investment in transport (current US$)}{marker topicid_IE.PPN.TRAN.CD}
...
{dlgtab: {help wbopendata_topicid##IE.PPN.WATR.CD:IE.PPN.WATR.CD} - Public private partnerships investment in water and sanitation (current US$)}{marker topicid_IE.PPN.WATR.CD}
...
{dlgtab: {help wbopendata_topicid##IP.IDS.NRCT:IP.IDS.NRCT} - Industrial design applications, nonresident, by count}{marker topicid_IP.IDS.NRCT}
...
{dlgtab: {help wbopendata_topicid##IP.IDS.RSCT:IP.IDS.RSCT} - Industrial design applications, resident, by count}{marker topicid_IP.IDS.RSCT}
...
{dlgtab: {help wbopendata_topicid##IP.TMK.NRCT:IP.TMK.NRCT} - Trademark applications, nonresident, by count}{marker topicid_IP.TMK.NRCT}
...
{dlgtab: {help wbopendata_topicid##IP.TMK.RSCT:IP.TMK.RSCT} - Trademark applications, resident, by count}{marker topicid_IP.TMK.RSCT}
...
{dlgtab: {help wbopendata_topicid##IQ.WEF.PORT.XQ:IQ.WEF.PORT.XQ} - Quality of port infrastructure, WEF (1=extremely underdeveloped to 7=well developed and efficient by international standards)}{marker topicid_IQ.WEF.PORT.XQ}
...
{dlgtab: {help wbopendata_topicid##IS.AIR.GOOD.MT.K1:IS.AIR.GOOD.MT.K1} - Air transport, freight (million ton-km)}{marker topicid_IS.AIR.GOOD.MT.K1}
...
{dlgtab: {help wbopendata_topicid##IS.AIR.PSGR:IS.AIR.PSGR} - Air transport, passengers carried}{marker topicid_IS.AIR.PSGR}
...
{dlgtab: {help wbopendata_topicid##IS.ROD.DNST.K2:IS.ROD.DNST.K2} - Road density (km of road per 100 sq. km of land area)}{marker topicid_IS.ROD.DNST.K2}
...
{dlgtab: {help wbopendata_topicid##IS.ROD.GOOD.MT.K6:IS.ROD.GOOD.MT.K6} - Roads, goods transported (million ton-km)}{marker topicid_IS.ROD.GOOD.MT.K6}
...
{dlgtab: {help wbopendata_topicid##IS.ROD.PSGR.K6:IS.ROD.PSGR.K6} - Roads, passengers carried (million passenger-km)}{marker topicid_IS.ROD.PSGR.K6}
...
{dlgtab: {help wbopendata_topicid##IS.ROD.TOTL.KM:IS.ROD.TOTL.KM} - Roads, total network (km)}{marker topicid_IS.ROD.TOTL.KM}
...
{dlgtab: {help wbopendata_topicid##IS.RRS.GOOD.MT.K6:IS.RRS.GOOD.MT.K6} - Railways, goods transported (million ton-km)}{marker topicid_IS.RRS.GOOD.MT.K6}
...
{dlgtab: {help wbopendata_topicid##IS.RRS.PASG.KM:IS.RRS.PASG.KM} - Railways, passengers carried (million passenger-km)}{marker topicid_IS.RRS.PASG.KM}
...
{dlgtab: {help wbopendata_topicid##IS.RRS.TOTL.KM:IS.RRS.TOTL.KM} - Rail lines (total route-km)}{marker topicid_IS.RRS.TOTL.KM}
...
{dlgtab: {help wbopendata_topicid##IS.SHP.GCNW.XQ:IS.SHP.GCNW.XQ} - Liner shipping connectivity index (maximum value in 2004 = 100)}{marker topicid_IS.SHP.GCNW.XQ}
...
{dlgtab: {help wbopendata_topicid##IS.SHP.GOOD.TU:IS.SHP.GOOD.TU} - Container port traffic (TEU: 20 foot equivalent units)}{marker topicid_IS.SHP.GOOD.TU}
...
{synopt:{opt Source Organization}}UNCTAD (http://unctad.org/en/Pages/statistics.aspx).{p_end}



{dlgtab: {help wbopendata_topicid##IS.VEH.NVEH.P3:IS.VEH.NVEH.P3} - Motor vehicles (per 1,000 people)}{marker topicid_IS.VEH.NVEH.P3}
...
{dlgtab: {help wbopendata_topicid##IS.VEH.PCAR.P3:IS.VEH.PCAR.P3} - Passenger cars (per 1,000 people)}{marker topicid_IS.VEH.PCAR.P3}
...
{dlgtab: {help wbopendata_topicid##IS.VEH.ROAD.K1:IS.VEH.ROAD.K1} - Vehicles (per km of road)}{marker topicid_IS.VEH.ROAD.K1}
...
{dlgtab: {help wbopendata_topicid##IT.CEL.SETS:IT.CEL.SETS} - Mobile cellular subscriptions}{marker topicid_IT.CEL.SETS}
...
{dlgtab: {help wbopendata_topicid##IT.CEL.SETS.P2:IT.CEL.SETS.P2} - Mobile cellular subscriptions (per 100 people)}{marker topicid_IT.CEL.SETS.P2}
...
{dlgtab: {help wbopendata_topicid##IT.CMP.PCMP.P2:IT.CMP.PCMP.P2} - Personal computers (per 100 people)}{marker topicid_IT.CMP.PCMP.P2}
...
{dlgtab: {help wbopendata_topicid##IT.MLT.MAIN:IT.MLT.MAIN} - Fixed telephone subscriptions}{marker topicid_IT.MLT.MAIN}
...
{dlgtab: {help wbopendata_topicid##IT.MLT.MAIN.P2:IT.MLT.MAIN.P2} - Fixed telephone subscriptions (per 100 people)}{marker topicid_IT.MLT.MAIN.P2}
...
{dlgtab: {help wbopendata_topicid##IT.NET.BBND:IT.NET.BBND} - Fixed broadband subscriptions}{marker topicid_IT.NET.BBND}
...
{dlgtab: {help wbopendata_topicid##IT.NET.BBND.P2:IT.NET.BBND.P2} - Fixed broadband subscriptions (per 100 people)}{marker topicid_IT.NET.BBND.P2}
...
{dlgtab: {help wbopendata_topicid##IT.NET.BNDW:IT.NET.BNDW} - International Internet bandwidth (Mbps)}{marker topicid_IT.NET.BNDW}
...
{dlgtab: {help wbopendata_topicid##IT.NET.BNDW.PC:IT.NET.BNDW.PC} - International Internet bandwidth (bits per person)}{marker topicid_IT.NET.BNDW.PC}
...
{dlgtab: {help wbopendata_topicid##IT.NET.SECR:IT.NET.SECR} - Secure Internet servers}{marker topicid_IT.NET.SECR}
...
{dlgtab: {help wbopendata_topicid##IT.NET.SECR.P6:IT.NET.SECR.P6} - Secure Internet servers (per 1 million people)}{marker topicid_IT.NET.SECR.P6}
...
{dlgtab: {help wbopendata_topicid##IT.NET.USER.P2:IT.NET.USER.P2} - Internet users (per 100 people)}{marker topicid_IT.NET.USER.P2}
...
{dlgtab: {help wbopendata_topicid##IT.NET.USER.ZS:IT.NET.USER.ZS} - Individuals using the Internet (% of population)}{marker topicid_IT.NET.USER.ZS}
...
{dlgtab: {help wbopendata_topicid##IT.PRT.NEWS.P3:IT.PRT.NEWS.P3} - Daily newspapers (per 1,000 people)}{marker topicid_IT.PRT.NEWS.P3}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.INVS.CN:IT.TEL.INVS.CN} - Telecommunications investment (current LCU)}{marker topicid_IT.TEL.INVS.CN}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.INVS.RV.ZS:IT.TEL.INVS.RV.ZS} - Telecommunications investment (% of revenue)}{marker topicid_IT.TEL.INVS.RV.ZS}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.REVN.CN:IT.TEL.REVN.CN} - Telecommunications revenue (current LCU)}{marker topicid_IT.TEL.REVN.CN}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.REVN.GD.ZS:IT.TEL.REVN.GD.ZS} - Telecommunications revenue (% GDP)}{marker topicid_IT.TEL.REVN.GD.ZS}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.TOTL:IT.TEL.TOTL} - Mobile and fixed-line telephone subscribers}{marker topicid_IT.TEL.TOTL}
...
{dlgtab: {help wbopendata_topicid##IT.TEL.TOTL.P2:IT.TEL.TOTL.P2} - Fixed line and mobile cellular subscriptions (per 100 people)}{marker topicid_IT.TEL.TOTL.P2}
...
{dlgtab: {help wbopendata_topicid##IT.TVS.HOUS.ZS:IT.TVS.HOUS.ZS} - Households with television (%)}{marker topicid_IT.TVS.HOUS.ZS}
