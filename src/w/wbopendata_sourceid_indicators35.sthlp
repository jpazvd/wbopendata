...
{synopt:{bf:{help wbopendata_sourceid##1.1_ACCESS.ELECTRICITY.TOT:1.1_ACCESS.ELECTRICITY.TOT} - Total final energy consumption (TFEC)}}
...
{synopt:{bf:{help wbopendata_sourceid##6.1_LEG.CA:6.1_LEG.CA} - Energy intensity level of primary energy (MJ/$2005 PPP)}}
