...
<<<<<<< HEAD
{title:Administrative Region  (as of 29oct2019)}
=======
{title:Administrative Region  (as of 12apr2020)}
>>>>>>> check
...
{p 20 20 2}(Go up to {it:{help wbopendata##adminregion:Administrative Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:Europe and Central Asia (excluding high income) (ECA)}
{synoptline}
...
{p 20 20 2}(Go up to {it:{help wbopendata##adminregion:Administrative Region }}){p_end}
{synoptset 33 tabbed}{...}
{synopthdr:Sub-Saharan Africa (excluding high income) (SSA)}
{synoptline}
