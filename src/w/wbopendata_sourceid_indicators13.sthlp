...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.CRM.CRIME2_C:IC.FRM.CRM.CRIME2_C} - If there were losses, average losses due to theft and vandalism (% of annual sales)}}
...
{synopt:{opt Source Notes}}If the establishment pays for security, for example equipment, personnel, or professional security services, the average security costs as a percentage of total annual sales.   Source:World Bank, Enterprise Surveys Project(http://www.enterpris{p_end}
>>>>>>> _parameter.ado
...
{synopt:{opt Source Notes}}Percent of firms identifying crime, theft and disorder as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:World Bank{p_end}
...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.FIN.FIN10:IC.FRM.FIN.FIN10} - Proportion of loans requiring collateral (%)}}
...
{synopt:{opt Source Notes}}Number of years firm operated without formal registration. This indicator is computed only for the firms that did not have a formal registration when they started their operations in the country.   Source:World Bank, Enterprise Surveys Project{p_end}
>>>>>>> _parameter.ado
...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.INFRA.IN11:IC.FRM.INFRA.IN11} - Percent of firms identifying electricity as a major constraint}}
...
{synopt:{opt Source Notes}}Percent of firms identifying transportation as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:World Bank, Enterpris{p_end}
>>>>>>> _parameter.ado
...
{synopt:{opt Source Notes}}Percent of firms that chose practices of the informal sector as the biggest obstacle faced by this establishment.  (Survey respondents were presented with a list of 15 potential obstacles.)   Source:World Bank, Enterprise Surveys Project(http:{p_end}
>>>>>>> _parameter.ado
...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.OBS.OBST5:IC.FRM.OBS.OBST5} - Percent of firms choosing crime, theft and disorder as their biggest obstacle}}
...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.OBS.OBST7:IC.FRM.OBS.OBST7} - Percent of firms choosing electricity as their biggest obstacle}}
...
{synopt:{opt Source Notes}}Percent of firms that chose customs and trade regulations as the biggest obstacle faced by this establishment.  (Survey respondents were presented with a list of 15 potential obstacles.)   Source:World Bank, Enterprise Surveys Project(http://w{p_end}
>>>>>>> _parameter.ado
...
{synopt:{opt Source Notes}}Percent of firms that chose inadequately educated workforce as the biggest obstacle faced by this establishment.  (Survey respondents were presented with a list of 15 potential obstacles.)   Source:World Bank, Enterprise Surveys Project(http:/{p_end}
>>>>>>> _parameter.ado
...
{synopt:{opt Source Notes}}Proportion of senior management’s time, in a typical week, that is spent dealing with the requirements imposed by government regulations (e.g. taxes, customs, labor regulations, licensing and registration, including dealings with officials,{p_end}
>>>>>>> _parameter.ado
...
<<<<<<< HEAD
{synopt:{bf:{help wbopendata_sourceid##IC.FRM.TRD.TR1:IC.FRM.TRD.TR1} - Percent of firms using material inputs and/or supplies of foreign origin}}
...
{synopt:{opt Source Notes}}Percent of firms that identifying customs and trade regulations as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:W{p_end}
>>>>>>> _parameter.ado
