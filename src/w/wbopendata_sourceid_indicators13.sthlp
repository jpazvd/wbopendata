...
{synoptset 25 tabbed}{...}
{synopthdr:13 Enterprise Surveys}
{synoptline}

{dlgtab: {help wbopendata_sourceid##IC.FRM.COR.ZS:IC.FRM.COR.ZS} - Firms identifying corruption as a major constraint (% of firms)}{marker sourceid_IC.FRM.COR.ZS}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR1:IC.FRM.CORR.CORR1} - Percent of firms expected to give gifts in meetings with tax officials}{marker sourceid_IC.FRM.CORR.CORR1}
...
{synopt:{opt Source Notes}}Percent of firms expected to give gifts or an informal payment to get an operating license.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR10:IC.FRM.CORR.CORR10} - Percent of firms expected to give gifts to get an operating license}{marker sourceid_IC.FRM.CORR.CORR10}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR11:IC.FRM.CORR.CORR11} - Percent of firms identifying corruption as a major constraint}{marker sourceid_IC.FRM.CORR.CORR11}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR2:IC.FRM.CORR.CORR2} - Percent of firms expected to give gifts to secure government contract}{marker sourceid_IC.FRM.CORR.CORR2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR3:IC.FRM.CORR.CORR3} - Value of gift expected to secure a government contract (% of contract value)}{marker sourceid_IC.FRM.CORR.CORR3}
...
{synopt:{opt Source Notes}}Percent of establishments that consider that firms with characteristics similar to theirs are making informal payments or giving gifts to public officials to get things done” with regard to customs, taxes, licenses, regulations, services, etc.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR4:IC.FRM.CORR.CORR4} - Percent of firms expected to give gifts to public officials to get things done}{marker sourceid_IC.FRM.CORR.CORR4}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR6:IC.FRM.CORR.CORR6} - Percent of firms expected to give gifts to get an electrical connection}{marker sourceid_IC.FRM.CORR.CORR6}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR7:IC.FRM.CORR.CORR7} - Percent of firms expected to give gifts to get a water connection}{marker sourceid_IC.FRM.CORR.CORR7}
...
{synopt:{opt Source Notes}}Percent of firms expected to give gifts or an informal payment to get a construction permit.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR8:IC.FRM.CORR.CORR8} - Percent of firms expected to give gifts to get a construction permit}{marker sourceid_IC.FRM.CORR.CORR8}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CORR9:IC.FRM.CORR.CORR9} - Percent of firms expected to give gifts to get an import license}{marker sourceid_IC.FRM.CORR.CORR9}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.CRIME9:IC.FRM.CORR.CRIME9} - Percent of firms identifying the courts system as a major constraint}{marker sourceid_IC.FRM.CORR.CRIME9}
...
{synopt:{opt Source Notes}}Percent of firms identifying the courts system as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/corruption)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.CORR.GRAFT2:IC.FRM.CORR.GRAFT2} - Bribery index (% of gift or informal payment requests during public transactions)}{marker sourceid_IC.FRM.CORR.GRAFT2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CRM.CRIME1:IC.FRM.CRM.CRIME1} - Percent of firms paying for security}{marker sourceid_IC.FRM.CRM.CRIME1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CRM.CRIME2_C:IC.FRM.CRM.CRIME2_C} - If the establishment pays for security, average security costs (% of annual sales)}{marker sourceid_IC.FRM.CRM.CRIME2_C}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CRM.CRIME3_C:IC.FRM.CRM.CRIME3_C} - If there were losses, average losses due to theft and vandalism (% of annual sales)}{marker sourceid_IC.FRM.CRM.CRIME3_C}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.CRM.CRIME5:IC.FRM.CRM.CRIME5} - Products shipped to supply domestic markets that were lost due to theft (% of product value)}{marker sourceid_IC.FRM.CRM.CRIME5}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FCHAR.CAR1:IC.FRM.FCHAR.CAR1} - Age of the establishment (years)}{marker sourceid_IC.FRM.FCHAR.CAR1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FCHAR.CAR2:IC.FRM.FCHAR.CAR2} - Proportion of private domestic ownership in a firm (%)}{marker sourceid_IC.FRM.FCHAR.CAR2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FCHAR.LFORM3:IC.FRM.FCHAR.LFORM3} - Percent of firms with legal status of Sole Proprietorship}{marker sourceid_IC.FRM.FCHAR.LFORM3}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN1:IC.FRM.FIN.FIN1} - Proportion of investment financed internally (%)}{marker sourceid_IC.FRM.FIN.FIN1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN10:IC.FRM.FIN.FIN10} - Value of collateral needed for a loan (% of the loan amount)}{marker sourceid_IC.FRM.FIN.FIN10}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN11:IC.FRM.FIN.FIN11} - Proportion of loans requiring collateral (%)}{marker sourceid_IC.FRM.FIN.FIN11}
...
{synopt:{opt Source Notes}}Proportion of loans requiring collateral in order to get the financing.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/finance)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/finance)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN12:IC.FRM.FIN.FIN12} - Percent of firms using banks to finance investments}{marker sourceid_IC.FRM.FIN.FIN12}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN13:IC.FRM.FIN.FIN13} - Percent of firms using banks to finance working capital}{marker sourceid_IC.FRM.FIN.FIN13}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN14:IC.FRM.FIN.FIN14} - Percent of firms with a bank loan/line of credit}{marker sourceid_IC.FRM.FIN.FIN14}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN15:IC.FRM.FIN.FIN15} - Percent of firms with a checking or savings account}{marker sourceid_IC.FRM.FIN.FIN15}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN16:IC.FRM.FIN.FIN16} - Percent of firms identifying access to finance as a major constraint}{marker sourceid_IC.FRM.FIN.FIN16}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN2:IC.FRM.FIN.FIN2} - Proportion of investment financed by banks (%)}{marker sourceid_IC.FRM.FIN.FIN2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN20:IC.FRM.FIN.FIN20} - Percent of firms not needing a loan}{marker sourceid_IC.FRM.FIN.FIN20}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.FIN.FIN21:IC.FRM.FIN.FIN21} - Percent of firms whose recent loan application was rejected}{marker sourceid_IC.FRM.FIN.FIN21}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.GEN.GEND1:IC.FRM.GEN.GEND1} - Percent of firms with female participation in ownership}{marker sourceid_IC.FRM.GEN.GEND1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.GEN.GEND2:IC.FRM.GEN.GEND2} - Proportion of permanent full-time workers that are female (%)}{marker sourceid_IC.FRM.GEN.GEND2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.GEN.GEND3:IC.FRM.GEN.GEND3} - Proportion of permanent full-time non-production workers that are female (%)}{marker sourceid_IC.FRM.GEN.GEND3}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.GEN.GEND4:IC.FRM.GEN.GEND4} - Percent of firms with a female top manager}{marker sourceid_IC.FRM.GEN.GEND4}
...
{synopt:{opt Source Notes}}Percent of firms with a female top manager.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/gender)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/gender)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INFOR.INFOR1:IC.FRM.INFOR.INFOR1} - Percent of firms competing against unregistered or informal firms}{marker sourceid_IC.FRM.INFOR.INFOR1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFOR.INFOR2:IC.FRM.INFOR.INFOR2} - Percent of firms identifying practices of competitors in the informal sector as a major constraint}{marker sourceid_IC.FRM.INFOR.INFOR2}
...
{synopt:{opt Source Notes}}Percent of firms formally registered when they started operations in the country.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/informality)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/informality)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INFOR.INFOR4:IC.FRM.INFOR.INFOR4} - Percent of firms formally registered when they started operations in the country}{marker sourceid_IC.FRM.INFOR.INFOR4}
...
{synopt:{opt Source Notes}}Number of years firm operated without formal registration. This indicator is computed only for the firms that did not have a formal registration when they started their operations in the country.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/informality)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/informality)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INFOR.INFOR5:IC.FRM.INFOR.INFOR5} - Number of years firm operated without formal registration}{marker sourceid_IC.FRM.INFOR.INFOR5}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN1:IC.FRM.INFRA.IN1} - Days to obtain an electrical connection (upon application)}{marker sourceid_IC.FRM.INFRA.IN1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN10_C:IC.FRM.INFRA.IN10_C} - If a generator is used, average proportion of electricity from a generator (%)}{marker sourceid_IC.FRM.INFRA.IN10_C}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN11:IC.FRM.INFRA.IN11} - Percent of firms identifying transportation as a major constraint}{marker sourceid_IC.FRM.INFRA.IN11}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN12:IC.FRM.INFRA.IN12} - Percent of firms identifying electricity as a major constraint}{marker sourceid_IC.FRM.INFRA.IN12}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN14:IC.FRM.INFRA.IN14} - Proportion of products lost to breakage or spoilage during shipping to domestic markets (%)}{marker sourceid_IC.FRM.INFRA.IN14}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN2:IC.FRM.INFRA.IN2} - Number of electrical outages in a typical month}{marker sourceid_IC.FRM.INFRA.IN2}
...
{synopt:{opt Source Notes}}If there were outages, duration of a typical power outage, in hours.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/infrastructure)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/infrastructure)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN3_C:IC.FRM.INFRA.IN3_C} - If there were outages, average duration of a typical electrical outage (hours)}{marker sourceid_IC.FRM.INFRA.IN3_C}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INFRA.IN6:IC.FRM.INFRA.IN6} - Percent of firms owning or sharing  a generator}{marker sourceid_IC.FRM.INFRA.IN6}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T1:IC.FRM.INNOV.T1} - Percent of firms with an internationally-recognized quality certification}{marker sourceid_IC.FRM.INNOV.T1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T2:IC.FRM.INNOV.T2} - Percent of firms with an annual financial statement reviewed by external auditors}{marker sourceid_IC.FRM.INNOV.T2}
...
{synopt:{opt Source Notes}}Percent of firms with an annual financial statement reviewed by external auditors.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/innovation-and-technology)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/innovation-and-technology)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T3:IC.FRM.INNOV.T3} - Capacity utilization (%)}{marker sourceid_IC.FRM.INNOV.T3}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T4:IC.FRM.INNOV.T4} - Percent of firms using technology licensed from foreign companies}{marker sourceid_IC.FRM.INNOV.T4}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T5:IC.FRM.INNOV.T5} - Percent of firms having their own Web site}{marker sourceid_IC.FRM.INNOV.T5}
...
{synopt:{opt Source Notes}}Percent of firms having their own Web site.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/innovation-and-technology)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/innovation-and-technology)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.INNOV.T6:IC.FRM.INNOV.T6} - Percent of firms using e-mail to interact with clients/suppliers}{marker sourceid_IC.FRM.INNOV.T6}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST1:IC.FRM.OBS.OBST1} - Percent of firms choosing access to finance as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST10:IC.FRM.OBS.OBST10} - Percent of firms choosing labor regulations as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST10}
...
{synopt:{opt Source Notes}}Percent of firms that chose labor regulations as the biggest obstacle faced by this establishment.  (Survey respondents were presented with a list of 15 potential obstacles.)   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/CustomQuery)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/CustomQuery)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST11:IC.FRM.OBS.OBST11} - Percent of firms choosing practices of the informal sector as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST11}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST12:IC.FRM.OBS.OBST12} - Percent of firms choosing practices of the informal sector as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST12}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST13:IC.FRM.OBS.OBST13} - Percent of firms choosing tax administration as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST13}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST14:IC.FRM.OBS.OBST14} - Percent of firms choosing tax rates as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST14}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST15:IC.FRM.OBS.OBST15} - Percent of firms choosing access to land as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST15}
...
{synopt:{opt Source Notes}}Percent of firms that chose access to land as the biggest obstacle faced by this establishment.  (Survey respondents were presented with a list of 15 potential obstacles.)   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/CustomQuery)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/CustomQuery)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST2:IC.FRM.OBS.OBST2} - Percent of firms choosing access to land as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST3:IC.FRM.OBS.OBST3} - Percent of firms choosing business licensing and permits as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST3}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST4:IC.FRM.OBS.OBST4} - Percent of firms choosing corruption as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST4}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST5:IC.FRM.OBS.OBST5} - Percent of firms choosing courts as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST5}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST6:IC.FRM.OBS.OBST6} - Percent of firms choosing crime, theft and disorder as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST6}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST7:IC.FRM.OBS.OBST7} - Percent of firms choosing customs and trade regulations as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST7}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST8:IC.FRM.OBS.OBST8} - Percent of firms choosing electricity as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST8}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.OBS.OBST9:IC.FRM.OBS.OBST9} - Percent of firms choosing inadequately educated workforce as their biggest obstacle}{marker sourceid_IC.FRM.OBS.OBST9}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.BUS1:IC.FRM.REG.BUS1} - Days to obtain an operating license}{marker sourceid_IC.FRM.REG.BUS1}
...
{synopt:{opt Source Notes}}The wait, in days, experienced to obtain an operating license from the day the establishment applied for it to the day it was granted.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/regulations-and-taxes)..{p_end}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.BUS2:IC.FRM.REG.BUS2} - Days to obtain a construction-related permit}{marker sourceid_IC.FRM.REG.BUS2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.BUS3:IC.FRM.REG.BUS3} - Days to obtain a construction-related permit}{marker sourceid_IC.FRM.REG.BUS3}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.BUS5:IC.FRM.REG.BUS5} - Percent of firms identifying business licensing and permits as a major constraint}{marker sourceid_IC.FRM.REG.BUS5}
...
{synopt:{opt Source Notes}}Percent of firms identifying business licensing and permits as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/regulations-and-taxes)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/regulations-and-taxes)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.REG1:IC.FRM.REG.REG1} - Senior management time spent dealing with the requirements of government regulation (%)}{marker sourceid_IC.FRM.REG.REG1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.REG2_C:IC.FRM.REG.REG2_C} - If there were visits, average number of visits or required meetings with tax officials}{marker sourceid_IC.FRM.REG.REG2_C}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.REG.REG4:IC.FRM.REG.REG4} - Percent of firms identifying tax rates as a major constraint}{marker sourceid_IC.FRM.REG.REG4}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR1:IC.FRM.TRD.TR1} - Days to clear direct exports through customs}{marker sourceid_IC.FRM.TRD.TR1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR11:IC.FRM.TRD.TR11} - Days to clear imports from customs}{marker sourceid_IC.FRM.TRD.TR11}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR2:IC.FRM.TRD.TR2} - Proportion of total sales that are exported directly (%)}{marker sourceid_IC.FRM.TRD.TR2}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR5:IC.FRM.TRD.TR5} - Proportion of total sales that are exported directly (%)}{marker sourceid_IC.FRM.TRD.TR5}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR8:IC.FRM.TRD.TR8} - Proportion of total inputs that are of foreign origin (%)}{marker sourceid_IC.FRM.TRD.TR8}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.TRD.TR9:IC.FRM.TRD.TR9} - Percent of firms identifying customs and trade regulations as a major constraint}{marker sourceid_IC.FRM.TRD.TR9}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.WRKF.WK1:IC.FRM.WRKF.WK1} - Percent of firms offering formal training}{marker sourceid_IC.FRM.WRKF.WK1}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.WRKF.WK10:IC.FRM.WRKF.WK10} - Percent of firms identifying an inadequately educated workforce as a major constraint}{marker sourceid_IC.FRM.WRKF.WK10}
...
{dlgtab: {help wbopendata_sourceid##IC.FRM.WRKF.WK2:IC.FRM.WRKF.WK2} - Proportion of workers offered formal training (%)}{marker sourceid_IC.FRM.WRKF.WK2}
...
{synopt:{opt Source Notes}}Years of the top manager's experience working in the firm's sector.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/workforce)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/workforce)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.WRKF.WK8:IC.FRM.WRKF.WK8} - Years of the top manager's experience working in the firm's sector}{marker sourceid_IC.FRM.WRKF.WK8}
...
{synopt:{opt Source Notes}}Percent of firms identifying labor regulations as a major constraint. The computation of the indicator is based on the rating of the obstacle as a potential constraint to the current operations of the establishment.   Source:World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/workforce)..{p_end}

{synopt:{opt Source Organization}}World Bank, Enterprise Surveys Project(http://www.enterprisesurveys.org/Data/ExploreTopics/workforce)..{p_end}



{dlgtab: {help wbopendata_sourceid##IC.FRM.WRKF.WK9:IC.FRM.WRKF.WK9} - Percent of firms identifying labor regulations as a major constraint}{marker sourceid_IC.FRM.WRKF.WK9}
