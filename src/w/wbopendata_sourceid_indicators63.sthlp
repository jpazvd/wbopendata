...
{synopt:{bf:{help wbopendata_sourceid##HD.HCI.OVRL.UB:HD.HCI.OVRL.UB} - Human Capital Index (HCI), Female, Upper Bound (scale 0-1)}}
...
{synopt:{bf:{help wbopendata_sourceid##gwp2_n_7:gwp2_n_7} - Survival Rate from Age 15-60}}
