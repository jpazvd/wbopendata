...
{synopt:{opt Source Organization}}United Nations Population Division, World Population Prospects: 2019 Revision, supplemented with data provided by World Bank Staff.{p_end}
...
{synopt:{opt Source Notes}}Harmonized test scores from major international student achievement testing programs.They are measured in TIMSS-equivalent units, where 300 is minimal attainment and 625 is advanced attainment. Most recent estimates are used.  Year of most rec{p_end}
...
{synopt:{opt Source Notes}}Learning-adjusted years of school are calculated by multiplying the estimates of expected years of school by the ratio of most recent harmonized test scores to 625.{p_end}
...
{synopt:{opt Source Notes}}Percentage not stunted is calculated by subtracting stunting rates from 1. Most recent estimates are used.  Year of most recent estimate shown in data notes.{p_end}
