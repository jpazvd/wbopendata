...
{marker sourceid_63}
{p 40 20 2}(Go up to {it:{help wbopendata##sourceid:Source}} or {it:{help wbopendata_sourceid_indicators63##:TOC}}){p_end}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.AMRT.FE:HD.HCI.AMRT.FE} - Survival Rate from Age 15-60, Female}{marker sourceid_HD.HCI.AMRT.FE}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.AMRT.MA:HD.HCI.AMRT.MA} - Survival Rate from Age 15-60, Male}{marker sourceid_HD.HCI.AMRT.MA}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.EYRS:HD.HCI.EYRS} - Expected Years of School}{marker sourceid_HD.HCI.EYRS}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.EYRS.FE:HD.HCI.EYRS.FE} - Expected Years of School, Female}{marker sourceid_HD.HCI.EYRS.FE}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.EYRS.MA:HD.HCI.EYRS.MA} - Expected Years of School, Male}{marker sourceid_HD.HCI.EYRS.MA}
...
{synopt:{opt Source Organization}}Patrinos and Angrist (2018).  http://documents.worldbank.org/curated/en/390321538076747773/Global-Dataset-on-Education-Quality-A-Review-and-Update-2000-2017.{p_end}
...
{synopt:{opt Source Organization}}Patrinos and Angrist (2018).  http://documents.worldbank.org/curated/en/390321538076747773/Global-Dataset-on-Education-Quality-A-Review-and-Update-2000-2018.{p_end}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.LAYS:HD.HCI.LAYS} - Learning-Adjusted Years of School}{marker sourceid_HD.HCI.LAYS}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.LAYS.MA:HD.HCI.LAYS.MA} - Learning-Adjusted Years of School, Male}{marker sourceid_HD.HCI.LAYS.MA}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.MORT:HD.HCI.MORT} - Probability of Survival to Age 5}{marker sourceid_HD.HCI.MORT}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.MORT.MA:HD.HCI.MORT.MA} - Probability of Survival to Age 5, Male}{marker sourceid_HD.HCI.MORT.MA}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.OVRL:HD.HCI.OVRL} - Human Capital Index (HCI) (scale 0-1)}{marker sourceid_HD.HCI.OVRL}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.OVRL.FE:HD.HCI.OVRL.FE} - Human Capital Index (HCI), Female (scale 0-1)}{marker sourceid_HD.HCI.OVRL.FE}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.OVRL.MA:HD.HCI.OVRL.MA} - Human Capital Index (HCI), Male (scale 0-1)}{marker sourceid_HD.HCI.OVRL.MA}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.OVRL.UB:HD.HCI.OVRL.UB} - Human Capital Index (HCI), Upper Bound (scale 0-1)}{marker sourceid_HD.HCI.OVRL.UB}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.STNT:HD.HCI.STNT} - Fraction of Children Under 5 Not Stunted}{marker sourceid_HD.HCI.STNT}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.STNT.FE:HD.HCI.STNT.FE} - Fraction of Children Under 5 Not Stunted, Female}{marker sourceid_HD.HCI.STNT.FE}
...
{dlgtab: {help wbopendata_sourceid##HD.HCI.STNT.MA:HD.HCI.STNT.MA} - Fraction of Children Under 5 Not Stunted, Male}{marker sourceid_HD.HCI.STNT.MA}
