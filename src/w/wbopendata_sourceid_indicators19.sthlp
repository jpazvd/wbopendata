...
{marker sourceid_19}
{p 40 20 2}(Go up to {it:{help wbopendata##sourceid:Source}} or {it:{help wbopendata_sourceid_indicators19##:TOC}}){p_end}

{synoptset 25 tabbed}{...}
{synopthdr:19 Millennium Development Goals}
{synoptline}

{dlgtab: {help wbopendata_sourceid##DC.ODA.COMM.CD:DC.ODA.COMM.CD} - Total bilateral ODA commitments (current US$)}{marker sourceid_DC.ODA.COMM.CD}
...
{dlgtab: {help wbopendata_sourceid##DC.ODA.COMM.SA.CD:DC.ODA.COMM.SA.CD} - Total bilateral sector allocable ODA commitments (current US$)}{marker sourceid_DC.ODA.COMM.SA.CD}
...
{dlgtab: {help wbopendata_sourceid##DC.ODA.SOCL.CD:DC.ODA.SOCL.CD} - Bilateral, sector-allocable ODA to basic social services (current US$)}{marker sourceid_DC.ODA.SOCL.CD}
...
{dlgtab: {help wbopendata_sourceid##DC.ODA.SOCL.ZS:DC.ODA.SOCL.ZS} - Bilateral, sector-allocable ODA to basic social services (% of bilateral ODA commitments)}{marker sourceid_DC.ODA.SOCL.ZS}
...
{dlgtab: {help wbopendata_sourceid##DC.ODA.UNTD.CD:DC.ODA.UNTD.CD} - Bilateral ODA commitments that is untied (current US$)}{marker sourceid_DC.ODA.UNTD.CD}
...
{dlgtab: {help wbopendata_sourceid##DC.ODA.UNTD.ZS:DC.ODA.UNTD.ZS} - Bilateral ODA commitments that is untied (% of bilateral ODA commitments)}{marker sourceid_DC.ODA.UNTD.ZS}
...
{dlgtab: {help wbopendata_sourceid##DT.HPC.COMR.PV:DT.HPC.COMR.PV} - Debt relief committed under HIPC initiative, cumulative US$ in end-2012 NPV terms}{marker sourceid_DT.HPC.COMR.PV}
...
{dlgtab: {help wbopendata_sourceid##DT.HPC.MDRI.PV:DT.HPC.MDRI.PV} - Debt relief delivered in full under MDRI initiative, cumulative US$ in end-2012 NPV terms}{marker sourceid_DT.HPC.MDRI.PV}
...
{dlgtab: {help wbopendata_sourceid##DT.HPC.STTS:DT.HPC.STTS} - Status under enhanced HIPC initiative}{marker sourceid_DT.HPC.STTS}
...
{dlgtab: {help wbopendata_sourceid##DT.HPC.TOTL.PV:DT.HPC.TOTL.PV} - Debt relief committed under HIPC and MDRI initiatives, cumulative US$ in end-2012 NPV terms}{marker sourceid_DT.HPC.TOTL.PV}
...
{dlgtab: {help wbopendata_sourceid##NY.AGR.SUBS.GD.ZS:NY.AGR.SUBS.GD.ZS} - Agricultural support estimate (% of GDP)}{marker sourceid_NY.AGR.SUBS.GD.ZS}
...
{dlgtab: {help wbopendata_sourceid##SH.HIV.KNOW.FE.ZS:SH.HIV.KNOW.FE.ZS} - % of females having comprehensive correct knowledge about HIV (2 prevent ways and reject 3 misconceptions)}{marker sourceid_SH.HIV.KNOW.FE.ZS}
...
{synopt:{opt Source Notes}}Knowledge of HIV, female, is the percentage of female respondents who correctly identify the two major ways of preventing the sexual transmission of HIV (using condoms and limiting sex to one faithful, uninfected partner), who reject the two most common local misconceptions about HIV transmission, and who know that a healthy-looking person can have HIV..{p_end}
...
{dlgtab: {help wbopendata_sourceid##TM.MRC.NOTX.LD.ZS:TM.MRC.NOTX.LD.ZS} - Goods (excluding arms) admitted free of tariffs from least developed countries (% total merchandise imports excluding arms)}{marker sourceid_TM.MRC.NOTX.LD.ZS}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.AGRI.CD.DV:TM.TAX.AGRI.CD.DV} - Average tariffs imposed by developed countries on agricultural products from developing countries (%)}{marker sourceid_TM.TAX.AGRI.CD.DV}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.AGRI.CD.LD:TM.TAX.AGRI.CD.LD} - Average tariffs imposed by developed countries on agricultural products from least developed countries (%)}{marker sourceid_TM.TAX.AGRI.CD.LD}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.CLTH.CD.DV:TM.TAX.CLTH.CD.DV} - Average tariffs imposed by developed countries on clothing products from developing countries (%)}{marker sourceid_TM.TAX.CLTH.CD.DV}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.CLTH.CD.LD:TM.TAX.CLTH.CD.LD} - Average tariffs imposed by developed countries on clothing products from least developed countries (%)}{marker sourceid_TM.TAX.CLTH.CD.LD}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.TXTL.CD.DV:TM.TAX.TXTL.CD.DV} - Average tariffs imposed by developed countries on textile products from developing countries (%)}{marker sourceid_TM.TAX.TXTL.CD.DV}
...
{dlgtab: {help wbopendata_sourceid##TM.TAX.TXTL.CD.LD:TM.TAX.TXTL.CD.LD} - Average tariffs imposed by developed countries on textile products from least developed countries (%)}{marker sourceid_TM.TAX.TXTL.CD.LD}
