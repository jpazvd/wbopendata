...
{synopt:{bf:{help wbopendata_sourceid##EN.CLC.CDDY.XD:EN.CLC.CDDY.XD} - Cooling Degree Days (projected change in number of degree Celsius)}}
...
{synopt:{bf:{help wbopendata_sourceid##EN.CLC.HEAT.XD:EN.CLC.HEAT.XD} - Heat Index 35 (projected change in days)}}
...
{synopt:{bf:{help wbopendata_sourceid##EN.CLC.PRCP.XD:EN.CLC.PRCP.XD} - Maximum 5-day Rainfall, 25-year Return Level (projected change in mm)}}
...
{synopt:{bf:{help wbopendata_sourceid##EN.CLC.SPEI.XD:EN.CLC.SPEI.XD} - Mean Drought Index (projected change, unitless)}}
