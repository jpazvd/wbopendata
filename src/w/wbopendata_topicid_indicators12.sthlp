...
{synoptset 25 tabbed}{...}
{syntab:{title:{bf:12 Private Sector}}}
{synoptline}
...
{synopt:{bf:{help wbopendata_topicid##IC.TAX.METG:IC.TAX.METG} - Number of visits or required meetings of affected firms with tax officials}}
