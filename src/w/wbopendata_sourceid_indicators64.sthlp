...
{synopt:{bf:{help wbopendata_sourceid##BI.EMP.PWRK.PB.FE.ZS:BI.EMP.PWRK.PB.FE.ZS} - Public sector employment as a share of paid employment by gender (Male)}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.EMP.PWRK.PB.MA.ZS:BI.EMP.PWRK.PB.MA.ZS} - Public sector employment as a share of paid employment by location (Rural)}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.POP.TOTL.CV:BI.POP.TOTL.CV} - Median age of public paid employees}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.PWK.PRVS.HS.ZS:BI.PWK.PRVS.HS.ZS} - Individuals with no education as a share of private paid employees}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.PWK.PRVS.SG.ZS:BI.PWK.PRVS.SG.ZS} - Females as a share of private paid employees by occupation (Senior officials)}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.PWK.PUBS.CK.FE.ZS:BI.PWK.PUBS.CK.FE.ZS} - Share of public paid employees with a contract}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.PWK.PUBS.RU.ZS:BI.PWK.PUBS.RU.ZS} - Individuals with secondary education as a share of public paid employees}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.WAG.PREM.PB.NN:BI.WAG.PREM.PB.NN} - Public sector wage premium by occupation (Professionals) (compared to formal wage employees)}}
...
{synopt:{bf:{help wbopendata_sourceid##BI.WAG.PUBS.TN:BI.WAG.PUBS.TN} - Wage bill as a percentage of GDP}}
